...
const languageStrings = {
  en: {
    translation: {
      ...
      SKILL_NAME: 'Volcanoes Knowledge Hub',
      WELCOME_MESSAGE: 'Welcome to %s. You can ask a question like, How to setup a %s? ... Now, what can I help you with?',
      WELCOME_REPROMPT: 'For instructions on what you can say, please say help me.',
      DISPLAY_CARD_TITLE: '%s  - Setup for %s.',
      HELP_MESSAGE: 'You can ask questions such as, How to setup a %s, or, you can say exit...Now, what can I help you with?',
      HELP_REPROMPT: 'You can say things like, How to setup a %s, or you can say exit...Now, what can I help you with?',
      STOP_MESSAGE: 'Goodbye!',
      RECIPE_REPEAT_MESSAGE: 'Try saying repeat.',
      RECIPE_NOT_FOUND_MESSAGE: 'I\'m sorry, I currently do not know ',
      RECIPE_NOT_FOUND_WITH_ITEM_NAME: 'the HowTo for %s. ',
      RECIPE_NOT_FOUND_WITHOUT_ITEM_NAME: 'that HowTo. ',
